...
#from there, lets filter out the players who don't have a dog
...
#let's change the names of some of the columns
hockey_stats_fruit_pets <- rename(.data=hockey_stats_fruit_pets,
